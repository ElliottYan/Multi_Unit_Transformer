...
from onmt.modules import MultiHeadedAttention, AverageAttention, MultiHeadedCausalAttention
...
class TransformerDecoderLayer(nn.Module):
    ...
    def __init__(self, d_model, heads, d_ff, dropout, attention_dropout,
        ...
        if self_attn_type == "scaled-dot":
            self.self_attn = MultiHeadedCausalAttention(
...
class TransformerCausal(DecoderBase):
    ...
    def __init__(self, num_layers, d_model, heads, d_ff,
                 ...
                 alignment_heads=None):
        super(TransformerCausal, self).__init__()

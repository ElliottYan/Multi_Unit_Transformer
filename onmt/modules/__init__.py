...
from onmt.modules.multi_headed_casual_attn import MultiHeadedCausalAttention
from onmt.modules.extra_loss_generator import ExtraLossGenerator, NMTLossComputeWithExtraLoss
...
__all__ = ["Elementwise", "context_gate_factory", "ContextGate",
           ...
           "WeightNormConv2d", "AverageAttention", "VecEmbedding","MultiHeadedCausalAttention",
           "ExtraLossGenerator", 'NMTLossComputeWithExtraLoss']

...
def build_translator(opt, report_score=True, logger=None, out_file=None):
    ...
    translator = PosTranslator.from_opt(
        model,
        fields,
        opt,
        model_opt,
...
class PosTranslator(object):
    ...
    def __init__(
        ...
        self.src_pos_reader = src_pos_reader
    ...
    def translate(
        ...
        src_pos_data = {"reader": self.src_pos_reader, "data": src_pos, "dir": src_dir}
        tgt_data = {"reader": self.tgt_reader, "data": tgt, "dir": None}
        _readers, _data, _dir = inputters.Dataset.config(
            [('src', src_data),  ('src_pos', src_pos_data), ('tgt', tgt_data)])

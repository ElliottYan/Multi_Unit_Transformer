...
from onmt.modules import Embeddings, VecEmbedding, CopyGenerator, ExtraLossGenerator
...
def build_base_model(model_opt, fields, gpu, checkpoint=None, gpu_id=None):
    ...
    if not model_opt.copy_attn:
        # if model_opt.extra_loss_weight > 0.0:
        #     generator = ExtraLossGenerator(model_opt, 
